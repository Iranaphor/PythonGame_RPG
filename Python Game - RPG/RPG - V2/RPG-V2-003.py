...
def bank(itemsList, itemQuant, itemsBagCapacity, bankedItems, bankedItemsQuant, bankSize):
    ...
    while (tempVarLoop1 == 0):
        ...
        if (choice.upper() == "W"):#Withdraw
            ...
            print()
##    ##            inventoryFile = open('inventoryFile.txt', 'w')
##    ##            inventoryFile.write(str(len(itemsList)))
##    ##            inventoryFile.write(str(len(bankedItems)))#Use these for the len() use.
##    ##            i = 0
##    ##            while (i < len(itemsList)):
##    ##                inventoryFile.write(itemsList[i])
##    ##                inventoryFile.write("\n")
##    ##                i = i + 1
##    ##            i = 0
##    ##            while (i < len(itemQuant)):
##    ##                inventoryFile.write(str(itemQuant[i]))
##    ##                inventoryFile.write("\n")
##    ##                i = i + 1
##    ##            i = 0
##    ##            while (i < len(bankedItems)):
##    ##                inventoryFile.write(bankedItems[i])
##    ##                inventoryFile.write("\n")
##    ##                i = i + 1
##    ##            i = 0
##    ##            while (i < len(bankedItemsQuant)):
##    ##                inventoryFile.write(str(bankedItemsQuant[i]))
##    ##                inventoryFile.write("\n")
##    ##                i = i + 1
##    ##            i = 0
##    ##            inventoryFile.close()
...
while (alive == True):
    ...
    if (actionChoice == "1"):#Move
        ...
        if (xLocation == -1) and (yLocation == 1) and (zLocation == 0):
            bank(itemsList, itemQuant, itemsBagCapacity, bankedItems, bankedItemsQuant, bankSize)
            print("Returned: ", itemsList)
##    ##            inventoryFile = open('inventoryFile.txt', 'w')
##    ##            itemIndex = int(inventoryFile.readline())
##    ##            bankIndex = int(inventoryFile.readline())
##    ##            i = 0
##    ##            while (i < itemIndex):
##    ##                inventoryFile.write(itemsList[i])
##    ##                i = i + 1
##    ##            i = 0
##    ##            while (i < itemIndex):
##    ##                inventoryFile.write(itemQuant[i])
##    ##                i = i + 1
##    ##            i = 0
##    ##            while (i < bankIndex):
##    ##                inventoryFile.write(bankedItems[i])
