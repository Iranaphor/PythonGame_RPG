...
##        print()
    ...
    if (actionChoice == "1"):#Move
        ...
        (movementResponseA, movementResponseB, movementResponseC, movementResponseD)  = Movement(xLocation, yLocation, zLocation, location)
        print(xLocation)
        print(yLocation)
        print(zLocation)
        print(location)
        print()
        print(movementResponseA)
        print(movementResponseB)
        print(movementResponseC)
        print(movementResponseD)
