...
#print("█ 2. Add economy properly.")
#print("█ 3. Add Inspect option for Seafront Shops.")
#print("█ 4. Add option for Inspect to choose between [Look Around ¦ Use Item ¦ Speak to Person]")
#print("█ 5. Add Eat Food options for food pouch (remove max food carrying limit and add food too items pouch).")
#print("█ 5. Add graphpical borders to warnings and information.")
                    ...
                    if (len(bankedItems) == 0):
                        ...
                        if ((witemID <= len(bankedItems)) and (witemID > 0)):
                            if (sum(itemQuant) + int(wquantity) > int(itemsBagCapacity)):
                                ...
                                if (wquantity == bankedItemsQuant[witemID - 1]):#withdraw full ammount;
