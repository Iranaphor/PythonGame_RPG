...
batAttackExp = 5
batDefenceExp = 5
batDrops = ("bat corpse", "bat bones", "bar of gold", "skill token", "diamond ring")
...
def objectInspection():
    if (object == "bat"):
        ...
        print ("█ It seems to have a weakness to fire...and Jamacians...")
    ...
    if(decision == 3):
        ...
        while (decision == 1):
            ...
            while (creatureHealth == 0):
                ...
                print("█      ║  Total Items: ", len(droppedItems), "              ║")
                print("█      ╚════════════════════════════════╝")
                print("█")
##                listMerge1 = 0
##                while(listMerge1 < len(droppedItems)):
##                    droppedItemDecision = int(input("█ [ 0 ~", len(droppedItems),"]: "))
##                    if (droppedItemDecision > 0) and ((droppedItemDecison < len(droppedItems) + 1)):#if it is a valid item to take
##                        dIDQ = int(input("█ [ 0 ~", droppedItemsQuant[droppedItemDecison],"]: "))
##                        if (dIDQ > 0) and (dIDQ <= droppedItemsQuant[droppedItemDecison]):#if it is a valid quantity to take
##                            if (sum(itemQuant) + dIDQ <= itemsBagCapacity ):
                listMerge = 0
                if (droppedItems[listMerge] in itemsList):#if it is in the list?
                ...
                listMerge += 1
##                            else:
##                                print("█ You cannot carry all of these items.")
##                        elif(dIDQ < 0):
##                            print()#return
##                        else:
##                            print("█ Aint no time fo dat!")
...
while (alive == True):
    ...
    if (actionChoice == "1"):#Move
        ...
        while(movementVar0 == 0):
            ...
            elif (xLocation == 1) and (yLocation == 0) and (zLocation == 0): #Forest Entrance
                print("█")
                print("█   What direction would you like to move in?")
