    ...
    while (u):
        ...
        if(decision == "3"):
            ...
            while (decision == "1"):
                ...
                print("║                                                  ╠──────────────────┬───────╣")
                print("║                                                  ║ Max Health       │", str(creatureMaxHealth).strip(""), ( str("a a").strip("a") ) * (5 - len(str(creatureMaxHealth))), "║")
                print("║                                                  ║ Remaining Health │", str(creatureHealth).strip(""), ( str("a a").strip("a") ) * (5 - len(str(creatureHealth))), "║")
                print("║                                                  ║ Attack Level     │", str(creatureDamage).strip(""), ( str("a a").strip("a") ) * (5 - len(str(creatureDamage))), "║")
                print("║                                                  ║ Damage Type      │", str(creatureDamageType).strip(""), ( str("a a").strip("a") ) * (5 - len(str(creatureDamageType))), "║")
                print("╠══════════════════════════════════════════════════╩══════════════════╩═══════╝")
